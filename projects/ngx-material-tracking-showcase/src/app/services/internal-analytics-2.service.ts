...
export class InternalAnalytics2Service extends CustomTrackingService<BaseCustomTrackingMetadata, TrackingVisit, TrackingEvent> {
    ...
    override readonly METADATA_KEY: string = 'internalAnalytics2';
